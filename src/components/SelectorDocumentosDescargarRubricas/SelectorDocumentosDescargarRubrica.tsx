...
import style from './SelectorDocumentosDescargarRubrica.module.css';
...
const SelectorDocumentosDescargarRubirca: React.FC = () => {
    ...
    return (
        <div className={`${style['container']}`}>
            <h2 className={`${style['title']}`}>Descargar rúbricas</h2>
...
export default SelectorDocumentosDescargarRubirca;
